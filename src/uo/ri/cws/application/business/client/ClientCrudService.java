...
public interface ClientCrudService {
	 ...
	 */
	ClientDto addClient(ClientDto client, String recommenderId) throws BusinessException;
	 ...
	 *        DOES NOT throw BusinessException
	 */
	List<ClientDto> findClientsRecommendedBy(String sponsorID) throws BusinessException;
